      ...
      .on(
        ...
        (payload) => {
          ...
          if (updatedSession.verified) {
            ...
            setIsLoading(false);
            console.log('Session verified with details:', updatedSession.user_details);
          }
        }
      )
      .subscribe();
        ...
        <Flex p={8} flex={1} align={'center'} justify={'center'}>
          <Stack spacing={6} w={'full'} maxW={'lg'}>
            ...
            <Text fontSize={{ base: 'md', lg: 'lg' }} color={'gray.500'}>
              Your credentials have been verified successfully. Here are your details:
            </Text>
            <Stack 
              spacing={4} 
              p={4} 
            ...
            >
              <Text fontWeight={'bold'} fontSize={'lg'}>User Details:</Text>
              <Text 
                as={'pre'} 
                fontSize={'sm'} 
                whiteSpace={'pre-wrap'} 
